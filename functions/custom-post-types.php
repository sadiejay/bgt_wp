    ...
    */
    ...
    register_post_type('tour', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'singular_name' => __('Tour', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Tour', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Tour', 'html5blank'),
            'new_item' => __('New Tour', 'html5blank'),
            'view' => __('View Tours', 'html5blank'),
            'view_item' => __('View Tour', 'html5blank'),
            'search_items' => __('Search Tours', 'html5blank'),
            'not_found' => __('No Tours found', 'html5blank'),
        ...
        'menu_icon' => 'dashicons-location',   // http://www.kevinleary.net/wordpress-dashicons-list-custom-post-type-icons/
        'can_export' => true // Allows export in Tools > Export
    ));
    register_taxonomy(
        'type_of_tours',    // Taxonomy
        'tours',             // Object Type
        array(
            'label' => __( 'Type of Tours' ),
