...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('bgt-js', get_template_directory_uri() . '/bgt-frontend-final/js/main.js', array('jquery'), '1.0.0', true); // Custom scripts
...
{
    wp_register_style('bgt-styles', get_template_directory_uri() . '/bgt-frontend-final/css/styles.css', array(), '1.0', 'all');
    wp_enqueue_style('bgt-styles'); // Enqueue it!
}
